...
object TestData {
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                for (i in 0 until loopCount) {
                    ...
                    // generate a random duration between 0 to 4 hours
                    val duration = getRandomInt(MAX_DURATION).toLong()

                    // create a new TastTiming record with our random date and duration
    ...
    private fun randomDateTime(): Long {
        ...
        val gc = java.util.GregorianCalendar(year, month, 1)
        val day = 1 + getRandomInt(gc.getActualMaximum(java.util.GregorianCalendar.DAY_OF_MONTH) - 1)
